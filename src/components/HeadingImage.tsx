...
export const HeadingImage: React.FC<HeadingImage> = ({
  ...
  // return (
  //   <div className="mx-auto self-start overflow-hidden rounded-xl xs:h-[11.25rem] xs:w-[11.25rem] lg:mx-auto lg:h-auto lg:w-full lg:self-center">
  //     {isLoading ? (
  //       <div
  //         role="status"
  ...
  return (
    <div className="mx-auto overflow-hidden rounded-xl w-full h-[400px]">
      <Skeleton
        className="w-full h-full"
        placeholder={<Skeleton.Image />}
        loading={isLoading || !src}
      >
        <MediaRenderer
          src={src}
          width="100%"
